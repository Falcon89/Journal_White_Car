...
<title>Insert title here</title>
  ...
  <link rel='stylesheet prefetch' href='https://fonts.googleapis.com/css?family=Playfair+Display|Quicksand:400,700|Open+Sans|PT+Mono'>

      <link rel="stylesheet" href="pages/css/stylecredit.css">
...
Follow me on
------------
Codepen: http://codepen.io/mycnlz/
...
<script src='http://cdnjs.cloudflare.com/ajax/libs/jqueryui/1.11.2/jquery-ui.min.js'></script>
    ...
    <script src="pages/js/indexcredit.js"></script>
